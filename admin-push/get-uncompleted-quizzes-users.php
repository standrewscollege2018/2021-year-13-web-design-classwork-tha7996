<?php
  ...
  $get_subscribed_users_sql = "SELECT user_id,meta_value FROM wp_usermeta,wp_mlw_results WHERE wp_usermeta.meta_key='push_subscription' AND wp_usermeta.meta_value IS NOT NULL";
